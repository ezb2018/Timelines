 ...
 * @return array
 */
function exc_mb_sample_metaboxes( array $meta_boxes ) {
	...
	$fields = array(
		...
		array( 'id' => 'field-12', 'name' => 'Image upload field', 'type' => 'image', 'repeatable' => true, 'show_size' => false ),
	...
	$meta_boxes[] = array(
		'title' => 'EXC_MB Test - group (all fields)',
		'pages' => 'post',
		'fields' => array(
			array(
				'id' => 'gp',
...
add_filter( 'exc_mb_meta_boxes', 'exc_mb_sample_metaboxes' );
