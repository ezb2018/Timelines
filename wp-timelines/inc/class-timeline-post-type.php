...
class WPEX_TL_Posttype {
	...
	function register_metadata(array $meta_boxes){
		...
		$icon_des = esc_html__('Select icon (Ex: fa-star)', 'wp-timeline');
		...
		$speaker_settings = array(	
				...
				array( 'id' => 'wpex_icon', 'name' => esc_html__('Icon', 'wp-timeline'), 'default'=> '', 'type' => 'icon_awesome','desc' => $icon_des , 'repeatable' => false, 'multiple' => false, 'cols' => 6 ),
